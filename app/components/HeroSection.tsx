  ...
  return (
    <section className="jt-hero" id="home">
      ...
      <div className="jt-hero__sparks" aria-hidden>
        {SPARKS.map((s) => (
          <span key={s.id} className="spark" style={{
            ...
            animationDuration: s.duration, animationDelay: s.delay, opacity: s.opacity,
          }} />
        ))}
      </div>
      ...
      <div className="jt-hero__layout">
        {/* Parkview-style full-width banner */}
        ...
        <div className="jt-hero__bottom">
          ...
          <div className="jt-hero__stats">
            {STATS.map((stat, i) => (
              <div key={stat.label} className="jt-stat" style={{ animationDelay: `${1.4 + i * 0.15}s` }}>
